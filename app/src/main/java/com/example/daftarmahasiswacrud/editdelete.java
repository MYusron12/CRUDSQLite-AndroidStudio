    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Snama.equals("")){
                    Enama.requestFocus();
                    Toast.makeText(editdelete.this, "Silahkan isi nama", Toast.LENGTH_SHORT).show();
                } else if (Snim.equals("")){
                    Enim.requestFocus();
                    Toast.makeText(editdelete.this, "Silahkan isi nim", Toast.LENGTH_SHORT).show();
                } else if (Sjurusan.equals("")){
                    Ejurusan.requestFocus();
                    Toast.makeText(editdelete.this, "Silahkan isi jurusan", Toast.LENGTH_SHORT).show();
                } else {
                    db.UpdateMahasiswa(new modalMahasiswa(Sid, Snama, Snim, Sjurusan));
                    Toast.makeText(editdelete.this, "Data telah diupdate", Toast.LENGTH_SHORT).show();
                    finish();
                }
            }
        });
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(editdelete.this, "Data telah dihapus", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
